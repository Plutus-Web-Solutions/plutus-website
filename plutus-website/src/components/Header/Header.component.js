...
import { HeaderButtonDiv, HeaderButtons, HeaderDiv, HeaderGraphic, HeaderGraphicImg, HeaderLined, HeaderSolid, HeaderSubtitle, HeaderText, HeaderTitle } from "./Header.styles";
