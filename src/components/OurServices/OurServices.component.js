      ...
      <Row className="align-items-center" style={{ padding: "0 0 2em 0" }}>
        ...
        >
          <ServiceCard data-key='0' id='0' size={this.state.sizes[0]} >
            ...
            <ServicesCardTitle size={this.state.sizes[0]}>UI/UX</ServicesCardTitle>
        ...
        >
          <ServiceCard data-key='1'  id='1' size={this.state.sizes[1]} >
            ...
            <ServicesCardTitle size={this.state.sizes[1]}>Web Development</ServicesCardTitle>
        ...
        >
          <ServiceCard data-key='2'  id='2' size={this.state.sizes[2]} >
            ...
            <ServicesCardTitle size={this.state.sizes[2]}>Branding & Social Media</ServicesCardTitle>
